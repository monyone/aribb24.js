...
const MACRO = new Map([
  [0x60, (Uint8Array.from([0x1b, 0x24, 0x42, 0x1b, 0x29, 0x4a, 0x1b, 0x2a, 0x30, 0x1b, 0x2b, 0x20, 0x70, 0x0f, 0x1b, 0x7d]))], // 漢字系, 英数, ひらがな, マクロ, LS0, LS2R
  [0x61, (Uint8Array.from([0x1b, 0x24, 0x42, 0x1b, 0x29, 0x31, 0x1b, 0x2a, 0x30, 0x1b, 0x2b, 0x20, 0x70, 0x0f, 0x1b, 0x7d]))], // 漢字系, カタカナ, ひらがな
  [0x62, (Uint8Array.from([0x1b, 0x24, 0x42, 0x1b, 0x29, 0x20, 0x41, 0x1b, 0x2a, 0x30, 0x1b, 0x2b, 0x20, 0x70, 0x0f, 0x1b, 0x7d]))], // 漢字系, DRCS-1, ひらがな
  [0x63, (Uint8Array.from([0x1b, 0x28, 0x32, 0x1b, 0x29, 0x34, 0x1b, 0x2a, 0x35, 0x1b, 0x2b, 0x20, 0x70, 0x0f, 0x1b, 0x7d]))], // モザイクA, モザイクC, モザイクD
  [0x64, (Uint8Array.from([0x1b, 0x28, 0x32, 0x1b, 0x29, 0x33, 0x1b, 0x2a, 0x35, 0x1b, 0x2b, 0x20, 0x70, 0x0f, 0x1b, 0x7d]))], // モザイクA, モザイクB, モザイクD,
  [0x65, (Uint8Array.from([0x1b, 0x28, 0x32, 0x1b, 0x29, 0x20, 0x41, 0x1b, 0x2a, 0x35, 0x1b, 0x2b, 0x20, 0x70, 0x0f, 0x1b, 0x7d]))], // モザイクA, DRCS-1, モザイクD,
  [0x66, (Uint8Array.from([0x1b, 0x28, 0x20, 0x41, 0x1b, 0x29, 0x20, 0x42, 0x1b, 0x2a, 0x20, 0x43, 0x1b, 0x2b, 0x20, 0x70, 0x0f, 0x1b, 0x7d]))], // DRCS-1, DRCS-2, DRCS-3,
  [0x67, (Uint8Array.from([0x1b, 0x28, 0x20, 0x44, 0x1b, 0x29, 0x20, 0x45, 0x1b, 0x2a, 0x20, 0x46, 0x1b, 0x2b, 0x20, 0x70, 0x0f, 0x1b, 0x7d]))], // DRCS-4, DRCS-5, DRCS-6,
  [0x68, (Uint8Array.from([0x1b, 0x28, 0x20, 0x47, 0x1b, 0x29, 0x20, 0x48, 0x1b, 0x2a, 0x20, 0x49, 0x1b, 0x2b, 0x20, 0x70, 0x0f, 0x1b, 0x7d]))], // DRCS-7, DRCS-8, DRCS-9,
  [0x69, (Uint8Array.from([0x1b, 0x28, 0x20, 0x4a, 0x1b, 0x29, 0x20, 0x4b, 0x1b, 0x2a, 0x20, 0x4b, 0x1b, 0x2b, 0x20, 0x70, 0x0f, 0x1b, 0x7d]))], // DRCS-10, DRCS-11, DRCS-12,
  [0x6a, (Uint8Array.from([0x1b, 0x28, 0x20, 0x4d, 0x1b, 0x29, 0x20, 0x4e, 0x1b, 0x2a, 0x20, 0x4f, 0x1b, 0x2b, 0x20, 0x70, 0x0f, 0x1b, 0x7d]))], // DRCS-13, DRCS-14, DRCS-15,
  [0x6b, (Uint8Array.from([0x1b, 0x24, 0x42, 0x1b, 0x29, 0x20, 0x42, 0x1b, 0x2a, 0x30, 0x1b, 0x2b, 0x20, 0x70, 0x0f, 0x1b, 0x7d]))], // 漢字系, DRCS-2, ひらがな
  [0x6c, (Uint8Array.from([0x1b, 0x24, 0x42, 0x1b, 0x29, 0x20, 0x43, 0x1b, 0x2a, 0x30, 0x1b, 0x2b, 0x20, 0x70, 0x0f, 0x1b, 0x7d]))], // 漢字系, DRCS-3, ひらがな
  [0x6d, (Uint8Array.from([0x1b, 0x24, 0x42, 0x1b, 0x29, 0x20, 0x44, 0x1b, 0x2a, 0x30, 0x1b, 0x2b, 0x20, 0x70, 0x0f, 0x1b, 0x7d]))], // 漢字系, DRCS-4, ひらがな
  [0x6e, (Uint8Array.from([0x1b, 0x28, 0x31, 0x1b, 0x29, 0x30, 0x1b, 0x2a, 0x4a, 0x1b, 0x2b, 0x20, 0x70, 0x0f, 0x1b, 0x7d]))], // カタカナ, ひらがな, 英数,
  [0x6f, (Uint8Array.from([0x1b, 0x28, 0x4a, 0x1b, 0x29, 0x32, 0x1b, 0x2a, 0x20, 0x41, 0x1b, 0x2b, 0x20, 0x70, 0x0f, 0x1b, 0x7d]))], // 英数, モザイクA, DRCS-1
]);
