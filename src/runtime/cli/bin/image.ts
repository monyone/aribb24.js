...
import { CompositionState, EndSegment, ObjectDefinitionSegment, PaletteDefinitionSegment, PresentationCompositionSegment, SegmentType, SequenceFlag, WindowDefinitionSegment, encodeSegment } from '../../../lib/encoder/pgs';
